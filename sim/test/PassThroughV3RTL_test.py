...
from PassThroughV3RTL import PassThroughV3RTL
...
def test_directed( dump_vcd, test_verilog ):
  # 4 Bits16 ports
  run_test_vector_sim( PassThroughV3RTL( 4, 16 ), [
      "in_                                          out*",
...
def test_random( nports, nbits, dump_vcd, test_verilog ):
  ...
  run_test_vector_sim( PassThroughV3RTL( nports, nbits ), tvectors, dump_vcd, test_verilog )
