...
from PassThroughV3 import PassThroughV3
...
def test_directed( cmdline_opts ):
  run_test_vector_sim( PassThroughV3( 4, 16 ), [
      "in_                                          out*",
...
def test_random( nports, nbits, cmdline_opts ):
  ...
  run_test_vector_sim( PassThroughV3( nports, nbits ), tvectors, cmdline_opts )
